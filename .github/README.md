...
[`@aws-sdk/client-emr`](https://www.npmjs.com/package/@aws-sdk/client-emr/v/3.180.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr@3.180.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2CVCO+wKnuAT97t/5FS4dyPSpFi3KbLOyvDX8KWJfPcqWTP/eNUGZroIuI4uiIaS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr@3.180.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr@3.180.0/index.min.mjs": "sha384-2CVCO+wKnuAT97t/5FS4dyPSpFi3KbLOyvDX8KWJfPcqWTP/eNUGZroIuI4uiIaS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr/blob/refs/tags/3.180.0/LICENSE
```
