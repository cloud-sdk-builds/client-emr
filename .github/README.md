...
[`@aws-sdk/client-emr`](https://www.npmjs.com/package/@aws-sdk/client-emr/v/3.956.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr@3.956.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-SmUjJYyGxFrYfF3moDHca/J/+i+IN3zK0aTHu7Eg+7rlfR+un1pvm321UEOd5jGD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr@3.956.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr@3.956.0/index.min.mjs": "sha384-SmUjJYyGxFrYfF3moDHca/J/+i+IN3zK0aTHu7Eg+7rlfR+un1pvm321UEOd5jGD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr/blob/refs/tags/3.956.0/LICENSE
```
